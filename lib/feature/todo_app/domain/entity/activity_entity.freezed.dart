...
abstract class $ActivityEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String description, String priority, bool isDone});
}
...
class _$ActivityEntityImpl implements _ActivityEntity {
  ...
  @override
  String toString() {
    return 'ActivityEntity(title: $title, description: $description, priority: $priority, isDone: $isDone)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, title, description, priority, isDone);
...
abstract class _ActivityEntity implements ActivityEntity {
  const factory _ActivityEntity(
      ...
      final String description,
      final String priority,
      final bool isDone}) = _$ActivityEntityImpl;
